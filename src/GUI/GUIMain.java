...
public class GUIMain extends javax.swing.JFrame
{
            ...
            public void mouseClicked(final MouseEvent e)
            {
                if (e.getClickCount() == 1)
                {
                    ...
                    try
                    {
                        ...
                        SimilarOrderModel = new SimilarOrderTableModel(po.getSimilarOrders(SimilarWidth));
        ...
        tblSimilarOrders.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(final MouseEvent e)
            {
                if (e.getClickCount() == 1)
                {
                    ...
                    try
                    {
                        SimilarSleeveModel = new SimilarSleeveTableModel(slm.getNewSimilarSleeve(SleeveID));
                    } catch (Exception ex)
                    {
                        Logger.getLogger(GUIMain.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void Initialize()
    {
        try
        {
            SimilarOrderModel = new SimilarOrderTableModel(po.getSimilarOrders(0.0));
            ...
            SimilarSleeveModel = new SimilarSleeveTableModel(slm.getNewSimilarSleeve(0));
